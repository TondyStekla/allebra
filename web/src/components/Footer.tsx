        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              Boutique SAP consulting, senior-led by design. We absorb the
              complexity so your team stays focused on what matters.
            </p>

            {/* Social */}
            <div className="flex gap-4 mt-6">
              <a
                href="https://www.linkedin.com/company/allebra"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/allebra_it"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-bold tracking-widest uppercase text-gray-400 mb-5">
              Quick Links
            </h4>
